defmodule App.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule AppWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: App.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: AppWeb.Router, endpoint: AppWeb.Endpoint}
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:app, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
